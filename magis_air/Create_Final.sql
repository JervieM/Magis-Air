...
CREATE TABLE "flight_booking_passenger" (
    "passenger_id" varchar(17) NOT NULL PRIMARY KEY,
...
CREATE TABLE "flight_booking_booking" (
    ...
    "passenger_id" varchar(17) NOT NULL,
    CONSTRAINT "flight_booking_booki_flight_id_6eb7a670_fk_flight_ro" 
        FOREIGN KEY ("flight_id") REFERENCES "flight_routes_flight" ("flight_id") 
        DEFERRABLE INITIALLY DEFERRED,
    CONSTRAINT "flight_booking_booki_passenger_id_c4f9fcdc_fk_flight_bo" 
        FOREIGN KEY ("passenger_id") REFERENCES "flight_booking_passenger" ("passenger_id") 
        DEFERRABLE INITIALLY DEFERRED
);

CREATE INDEX "flight_booking_additionalitem_item_id_acacec33_like" 
    ON "flight_booking_additionalitem" ("item_id" varchar_pattern_ops);

CREATE INDEX "flight_booking_passenger_passenger_id_31f5800f_like" 
    ON "flight_booking_passenger" ("passenger_id" varchar_pattern_ops);

CREATE INDEX "flight_booking_booking_booking_id_c2983c9d_like" 
    ON "flight_booking_booking" ("booking_id" varchar_pattern_ops);
CREATE INDEX "flight_booking_booking_flight_id_6eb7a670" 
    ON "flight_booking_booking" ("flight_id");
CREATE INDEX "flight_booking_booking_flight_id_6eb7a670_like" 
    ON "flight_booking_booking" ("flight_id" varchar_pattern_ops);
CREATE INDEX "flight_booking_booking_passenger_id_c4f9fcdc" 
    ON "flight_booking_booking" ("passenger_id");
CREATE INDEX "flight_booking_booking_passenger_id_c4f9fcdc_like" 
    ON "flight_booking_booking" ("passenger_id" varchar_pattern_ops);
